package com.siiv.springboot.app.zuul.filters;
...
public class PostTiempoTranscurridoFilter extends ZuulFilter{
	...
	public Object run() throws ZuulException {
		...
		log.info(String.format("Tiempo Inicio en mileseg %s ms.", tiempoInicio));
		log.info(String.format("Tiempo Final en mileseg %s ms.", tiempoFinal ));
